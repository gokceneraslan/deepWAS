...
modelselection.df <- modelselection.df[order(modelselection.df$pval.adj),]
...
deepwas.hits.df <- cbind(deepwas.hits.df, as.data.frame(do.call(rbind, strsplit(deepwas.hits.df$model.deepsea, '|', fixed = T)), 
                                                        stringsAsFactors = F))
